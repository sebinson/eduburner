...
public class Futures {
  ...
  /**
   * Creates a {@link ListenableFuture} out of a normal {@link java.util.concurrent.Future}. The
  ...
  /**
   * Creates a {@link CheckedFuture} out of a normal {@link java.util.concurrent.Future} and a
   * {@link com.google.common.base.Function} that maps from {@link Exception} instances into the
   ...
   *
   * <p>When calling {@link java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit)} on the returned
