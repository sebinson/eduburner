 ...
 * 
 * <p>This class uses the {@link com.google.common.util.concurrent.AbstractFuture} class to implement the
 * {@code ListenableFuture} interface and simply delegates the
 * {@link #addListener(Runnable, java.util.concurrent.Executor)} and {@link #done()} methods to it.
 * 
 * @author Sven Mawson
