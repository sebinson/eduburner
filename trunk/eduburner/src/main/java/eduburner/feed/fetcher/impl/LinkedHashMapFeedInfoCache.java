...
/**
 * <p>An implementation of the {@link eduburner.feed.fetcher.IFeedFetcherCache.impl.FeedFetcherCache} interface.</p>
 * 
...
public class LinkedHashMapFeedInfoCache extends HashMapFeedInfoCache {
	 ...
	 */
	public static final IFeedFetcherCache getInstance() {
		return _instance;
	}
