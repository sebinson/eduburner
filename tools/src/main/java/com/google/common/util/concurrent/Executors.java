...
public class Executors {
  ...
  /**
   * Returns a {@link java.util.concurrent.ThreadFactory} which creates daemon threads. This is
   * implemented by wrapping {@link
   * java.util.concurrent.Executors#defaultThreadFactory()}, marking all new
   * threads as daemon threads
   *
   * @return a {@link java.util.concurrent.ThreadFactory} which creates daemon threads
   */
   ...
   * @return a new {@link java.util.concurrent.ThreadFactory} backed by {@code factory} whose created
