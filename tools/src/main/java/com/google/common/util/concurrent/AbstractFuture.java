...
/**
 * <p>An abstract implementation of the {@link java.util.concurrent.Future} interface.  This class
 * is an abstraction of {@link java.util.concurrent.FutureTask} to support use
 * for tasks other than {@link Runnable}s.  It uses an
 * {@link java.util.concurrent.locks.AbstractQueuedSynchronizer} to deal with concurrency issues and
...
public abstract class AbstractFuture<V> implements Future<V> {
   ...
   * {@link com.google.common.util.concurrent.AbstractFuture.Sync#COMPLETED} and call {@link #done()} if the
   ...
   * com.google.common.util.concurrent.AbstractFuture.Sync#CANCELLED} and call {@link #done()} if the state was
