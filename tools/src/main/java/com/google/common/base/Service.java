 ...
 * <ul>
 *   <li>{@link com.google.common.base.Service.State#NEW} -&gt;</li>
 *   <li>{@link com.google.common.base.Service.State#STARTING} -&gt;</li>
 *   <li>{@link com.google.common.base.Service.State#RUNNING} -&gt;</li>
 *   <li>{@link com.google.common.base.Service.State#STOPPING} -&gt;</li>
 *   <li>{@link com.google.common.base.Service.State#TERMINATED}</li>
 * </ul>
 *
 * If the service fails while starting, running or stopping, its state will be
 * {@link com.google.common.base.Service.State#FAILED}, and its behavior is undefined. Such a service cannot be
 * started nor stopped.
 *
...
public interface Service {
  /**
   * If the service state is {@link com.google.common.base.Service.State#NEW}, this initiates service startup
   ...
   *     initiated startup. Calling {@link java.util.concurrent.Future#get} will block until the
   *     service has finished starting, and returns one of {@link
   *     com.google.common.base.Service.State#RUNNING}, {@link com.google.common.base.Service.State#STOPPING} or {@link com.google.common.base.Service.State#TERMINATED}. If
   *     the service fails to start, {@link java.util.concurrent.Future#get} will throw an {@link
   *     java.util.concurrent.ExecutionException}, and the service's state will be {@link
   *     com.google.common.base.Service.State#FAILED}. If it has already finished starting, {@link java.util.concurrent.Future#get}
  ...
  /**
   * Returns {@code true} if this service is {@link com.google.common.base.Service.State#RUNNING running}.
   */
  boolean isRunning();
  ...
  /**
   * If the service is {@link com.google.common.base.Service.State#STARTING} or {@link com.google.common.base.Service.State#RUNNING}, this
   * initiates service shutdown and returns immediately. If this is {@link
   * com.google.common.base.Service.State#NEW}, it is {@link com.google.common.base.Service.State#TERMINATED terminated} without having been
   ...
   *     initiated shutdown. Calling {@link java.util.concurrent.Future#get} will block until the
   *     service has finished shutting down, and either returns {@link
   *     com.google.common.base.Service.State#TERMINATED} or throws an {@link java.util.concurrent.ExecutionException}. If it has
   *     already finished stopping, {@link java.util.concurrent.Future#get} returns immediately.
   ...
   * finished stopping. If this is {@link com.google.common.base.Service.State#STARTING}, startup will be
   * cancelled. If this is {@link com.google.common.base.Service.State#NEW}, it is {@link com.google.common.base.Service.State#TERMINATED
